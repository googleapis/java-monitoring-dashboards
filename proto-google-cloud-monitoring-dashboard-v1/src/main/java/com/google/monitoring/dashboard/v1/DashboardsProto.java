  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "e/api/resource.proto\032,google/monitoring/dashboard/v1/layouts.proto\"\270\003\n"
          + "\tDashboard\022\021\n"
          ...
          + "\0132*.google.monitoring.dashboard.v1.GridLayoutH\000\022E\n\r"
          + "mosaic_layout\030\006 \001(\0132,.google."
          ...
          + "column_layout\030\t"
          + " \001(\0132,.google.monitoring.dashboard.v1.ColumnLayoutH\000:S\352AP\n"
          + "#monitoring.googleap"
          + "is.com/Dashboard\022)projects/{project}/dashboards/{dashboard}B\010\n"
          + "\006layoutB\371\001\n"
          + "\"com.google.monitoring.dashboard.v1B\017Dashboards"
          + "ProtoP\001ZGgoogle.golang.org/genproto/googleapis/monitoring/dashboard/v1;dashboard"
          + "\252\002$Google.Cloud.Monitoring.Dashboard.V1\312"
          + "\002$Google\\Cloud\\Monitoring\\Dashboard\\V1\352\002"
          + "(Google::Cloud::Monitoring::Dashboard::V1b\006proto3"
    };
    descriptor =
