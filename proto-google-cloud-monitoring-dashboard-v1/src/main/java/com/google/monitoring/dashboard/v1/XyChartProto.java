...
public final class XyChartProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + ",google/monitoring/dashboard/v1/xychart.proto\022\036google.monitoring.dashboard.v1\032\037google/api/field_behavior.proto\032,google/monitoring/dashboard/v1/metrics.proto\032\036google/protobuf/duration.proto\"\375\006\n"
          + "\007XyChart\022G\n"
          + "\tdata_sets\030\001"
          + " \003(\0132/.google.monitoring.dashboard.v1.XyChart.DataSetB\003\340A\002\0225\n"
          + "\022timeshift_duration\030\004 \001(\0132\031.google.protobuf.Duration\022=\n\n"
          + "thresholds\030\005 \003(\0132).google.monitoring.dashboard.v1.Threshold\022<\n"
          + "\006x_axis\030\006 \001(\0132,.google.monitoring.dashboard.v1.XyChart.Axis\022<\n"
          + "\006y_axis\030\007 \001(\0132,.google.monitoring.dashboard.v1.XyChart.Axis\022C\n\r"
          + "chart_options\030\010"
          + " \001(\0132,.google.monitoring.dashboard.v1.ChartOptions\032\337\002\n"
          + "\007DataSet\022O\n"
          + "\021time_series_query\030\001"
          + " \001(\0132/.google.monitoring.dashboard.v1.TimeSeriesQueryB\003\340A\002\022K\n"
          + "\tplot_type\030\002"
          + " \001(\01628.google.monitoring.dashboard.v1.XyChart.DataSet.PlotType\022\027\n"
          + "\017legend_template\030\003 \001(\t\022<\n"
          + "\024min_alignment_period\030\004"
          + " \001(\0132\031.google.protobuf.DurationB\003\340A\001\"_\n"
          + "\010PlotType\022\031\n"
          ...
          + "\005scale\030\002 \001(\01622.google.monitoring.dashboard.v1.XyChart.Axis.Scale\"5\n"
          + "\005Scale\022\025\n"
          + "\021SCALE_UNSPECIFIED\020\000\022\n\n"
          + "\006LINEAR\020\001\022\t\n"
          + "\005LOG10\020\002\"\216\001\n"
          + "\014ChartOptions\022?\n"
          + "\004mode\030\001 \001(\01621.google.monitoring.dashboard.v1.ChartOptions.Mode\"=\n"
          + "\004Mode\022\024\n"
          + "\020MODE_UNSPECIFIED\020\000\022\t\n"
          + "\005COLOR\020\001\022\t\n"
          + "\005X_RAY\020\002\022\t\n"
          + "\005STATS\020\003B\366\001\n"
          + "\"com.google.monitoring.dashboard.v1B\014XyChartPr"
          ...
          + "oogle::Cloud::Monitoring::Dashboard::V1b\006proto3"
    };
    descriptor =
